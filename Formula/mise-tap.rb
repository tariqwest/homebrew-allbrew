class MiseTap < Formula
  desc "Install from https://mise.run"
  homepage "https://mise.run"
  url "https://mise.run"
  version "2026.8.6"
  sha256 "18ec854e24388880277a84e73434114eb80cdf2066afcf3671fed2682cb1ea4a"
  ...
  def install
    ...
    ENV["MISE_QUIET"] = "1"
    ENV["MISE_INSTALL_PATH"] = (buildpath/"bin"/"mise").to_s
