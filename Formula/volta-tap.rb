class VoltaTap < Formula
  desc "Install from https://get.volta.sh"
  homepage "https://get.volta.sh"
  url "https://get.volta.sh"
  version "2.0.2"
  sha256 "fbdc4b8cb33fb6d19e5f07b22423265943d34e7e5c3d5a1efcecc9621854f9cb"
  ...
  def install
    ...
    system "bash", cached_download.to_s, "--skip-setup", "--version", version.to_s
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/volta --version")
  end
end
